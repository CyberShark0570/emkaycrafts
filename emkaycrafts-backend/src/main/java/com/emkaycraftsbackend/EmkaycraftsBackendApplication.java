package com.emkaycraftsbackend;
...
import com.emkaycraftsbackend.repository.ProductRepository;
import com.emkaycraftsbackend.entity.Product;
import com.emkaycraftsbackend.repository.CustomItemRepository;

@SpringBootApplication
@EnableMongoRepositories
public class EmkaycraftsBackendApplication implements CommandLineRunner{
	...
	public static void main(String[] args) {
		SpringApplication.run(EmkaycraftsBackendApplication.class, args);
	}
	
	public void run(String... args) {
		
		// Clean up any previous data
		productRepository.deleteAll(); // Doesn't delete the collection
	...
	// 1. Show all the data
	 public void showAllGroceryItems() {
		 ...
		 itemList = productRepository.findAll();
	 ...
	 public void updateCategoryName(String category) {
		 ...
		 List<Product> itemsUpdated = productRepository.saveAll(list);
